                        ...
                        <div className="text-left">
                            ...
                            >
                                ...
                                <span className="text-xs text-gray-200/90">
                                    Trusted By Me To Make Cool Ads
                                </span>
                            </motion.a>
                            ...
                            >
                                Upload product images alongside the model, and you'll get a super cool AI ad within seconds.
                            </motion.p>
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400">
                                            Optimized For Instagram, Facebook, TikTok, and more
                                        </div>
                                    </div>
                                </div>
